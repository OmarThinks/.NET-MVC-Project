...
namespace SocialApp.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(SocialAppContext context)
        {
            _context = context;
        }
        ...
        {
            var socialAppContext = _context.Comment.Include(c => c.Post);
            return View(await socialAppContext.ToListAsync());
        }
